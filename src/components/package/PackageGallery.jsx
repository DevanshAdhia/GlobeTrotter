  ...
  return (
    <section className="mb-10">
      <div className="relative group rounded-3xl overflow-hidden bg-gray-100">
        <div className="overflow-hidden aspect-[4/3] md:aspect-[16/7]" ref={emblaRef}>
        ...
        <button aria-label="View all photos" onClick={() => setLightboxOpen(true)} className="absolute bottom-4 right-4 bg-white/90 backdrop-blur text-gray-900 px-4 py-2 rounded-xl text-sm font-bold flex items-center shadow-sm hover:bg-white transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary">
