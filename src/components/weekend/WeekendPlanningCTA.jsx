  ...
  return (
    <section className="py-20 relative overflow-hidden bg-[#0a192f] mt-16 rounded-3xl mx-4 lg:mx-8 mb-12">
      <div className="absolute inset-0">
        {/* Replaced broken image with a reliable Unsplash nature image */}
        <img src="https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=1600&q=80" alt="Adventure landscape" className="w-full h-full object-cover opacity-20" />
      </div>
      <div className="relative z-10 w-full max-w-4xl mx-auto px-6 text-center text-white">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
          <Link to="/plan" className="cta-btn-primary">
            Plan My Trip
          </Link>
