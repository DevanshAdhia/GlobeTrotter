...
const TravelCategories = () => {
  return (
    <section className="pt-24 pb-20 bg-gradient-to-b from-gray-50/60 via-white to-gray-50/40">
      <Container>
          ...
          {categories.map((cat, index) => {
            ...
            return (
              ...
              >
                <Link 
                  to={cat.link} 
                  className="group relative flex flex-col justify-between p-7 bg-white rounded-3xl border border-gray-100/90 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_16px_35px_rgba(0,71,179,0.1)] hover:border-primary/30 transition-all duration-300 hover:-translate-y-1.5 no-underline h-full"
                >
                  {/* Top Accent Line */}
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between mb-5">
                      <div className="w-13 h-13 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100/60 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white group-hover:scale-105 transition-all duration-300 shadow-sm p-3">
                        <Icon className="w-6 h-6" />
                      </div>

                      <span className="text-[10px] font-bold tracking-wider uppercase px-3 py-1 rounded-full bg-gray-100/90 text-gray-600 group-hover:bg-primary/10 group-hover:text-primary transition-colors">
                        {cat.badge}
                      </span>
                    </div>
